            ...
            return (
                <div
                    ...
                    className={cn({
                        ...
                        "bg-[#488DCD]": isMulti ? !isFirst || !isLast : isFirst,
                    })}
                ></div>
            );
        }}
        renderThumb={(props, state) => (
            <div
                ...
                className={cn({
                    "h-full": !isVertical,
                    "w-full": isVertical,
                    "aspect-square rounded-full bg-[#488DCD] text-xs text-white flex items-center justify-center cursor-grab":
                        true,
                })}
            >
                {state.valueNow}
